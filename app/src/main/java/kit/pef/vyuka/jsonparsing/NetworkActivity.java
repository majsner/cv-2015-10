...
public class NetworkActivity extends Activity implements IAsyncResponse {
    ...
    private String[] loadJSON() throws IOException {
        ...
        try {
            ...
            URL url = new URL("http://kit.pef.czu.cz/weather.json");
    ...
    private InputStream download(URL url, HttpURLConnection urlConnection) {
        try {
    ...
    private String convertIS(InputStream inputStream, BufferedReader reader) {
